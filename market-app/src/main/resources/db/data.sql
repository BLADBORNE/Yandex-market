...
VALUES ('Ноутбук ASUS VivoBook', '15.6" Full HD, Intel Core i5, 8GB RAM, 512GB SSD', 'images/product1.jpg', 54999),
       ...
       ('Портативная колонка JBL Flip', 'Bluetooth, 20ч, водозащита IPX7, JBL PartyBoost', 'images/product12.jpg', 8999),
       ('Фитнес-браслет Xiaomi Band', 'AMOLED 1.62", пульсоксиметр, 15 дней автономность', 'images/product13.jpg', 3999),
...
SELECT o.id,
       ...
       bp.count
FROM market."order" o
JOIN market.basket_product bp ON bp.basket_id = o.basket_id
